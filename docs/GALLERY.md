...
![Copenhagen: Twelve games on a green felt table, with warm ivory accents and KAMI selected. Keep a pick, replace it, or shuffle the table.](screenshots/10-copenhagen.png)
...
![Cupertino: Night in the Woods anchors a carousel of favorites, with angled covers and soft reflections.](screenshots/01-cupertino.png)
...
![Ulm: A spacious title list, understated controller hints, and a single Tengami cover show the quieter side of Wayfinder.](screenshots/03-ulm.png)
...
![Venice: A symmetrical fan of adventure covers surrounds The Silent Age, with warm accents and a restrained background.](screenshots/04-venice.png)
...
![Cambridge: Categories, titles, and artwork occupy three clear panes. KAMI brings a little color to a compact, text-focused browser.](screenshots/05-cambridge.png)
