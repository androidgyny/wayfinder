const builtinAppearancePresets=[{"name":"Default","values":{"presentation":"library","palette":"portal","typography":"clean","coverGlow":false,"backdrop":"flat","selectionStyle":"outline","artFit":"cover","size":"comfortable","cupertinoReflections":"subtle","cupertinoSpacing":"airy","berlinCoverSize":120,"kyotoTitlePlacement":"above","cupertinoTitlePlacement":"above","viennaSeparators":"lines","coverCorners":"soft","coverBrightness":"even","menuButtons":"all","coverBorder":"none","interfaceContrast":"soft","titleWeight":"medium","coverShadow":"off"}},{"name":"Fan Favorite","values":{"presentation":"venice","palette":"terracotta","typography":"outfit","coverGlow":false,"backdrop":"flat","selectionStyle":"underline","artFit":"cover","size":"comfortable","cupertinoReflections":"subtle","cupertinoSpacing":"airy","berlinCoverSize":120,"kyotoTitlePlacement":"above","cupertinoTitlePlacement":"above","viennaSeparators":"lines","coverCorners":"soft","coverBrightness":"even","menuButtons":"selected","coverBorder":"hairline","interfaceContrast":"soft","titleWeight":"medium","backgroundColor":"original","backgroundDim":60,"coverShadow":"off"}},{"name":"Folio Nova","values":{"presentation":"vienna","palette":"parchment","typography":"clean","coverGlow":false,"backdrop":"flat","selectionStyle":"underline","artFit":"cover","size":"comfortable","cupertinoReflections":"subtle","cupertinoSpacing":"airy","berlinCoverSize":120,"kyotoTitlePlacement":"above","cupertinoTitlePlacement":"above","viennaSeparators":"space","coverCorners":"square","coverBrightness":"even","menuButtons":"selected","coverBorder":"none","interfaceContrast":"soft","titleWeight":"bold","backgroundColor":"original","backgroundDim":60,"coverShadow":"soft"}},{"name":"Full House","values":{"presentation":"copenhagen","palette":"felt","typography":"clean","coverGlow":false,"backdrop":"flat","selectionStyle":"outline","artFit":"cover","size":"comfortable","cupertinoReflections":"subtle","cupertinoSpacing":"airy","berlinCoverSize":120,"kyotoTitlePlacement":"above","cupertinoTitlePlacement":"above","viennaSeparators":"lines","coverCorners":"soft","coverBrightness":"even","menuButtons":"selected","coverBorder":"hairline","interfaceContrast":"soft","titleWeight":"medium","coverShadow":"crisp","backgroundColor":"original","backgroundDim":60}},{"name":"iTomes","values":{"presentation":"cupertino","palette":"graphite","typography":"clean","coverGlow":false,"backdrop":"flat","selectionStyle":"underline","artFit":"cover","size":"comfortable","cupertinoReflections":"classic","cupertinoSpacing":"compact","berlinCoverSize":120,"kyotoTitlePlacement":"above","cupertinoTitlePlacement":"below","viennaSeparators":"space","coverCorners":"square","coverBrightness":"even","menuButtons":"selected","coverBorder":"hairline","interfaceContrast":"soft","titleWeight":"medium","coverShadow":"off"}},{"name":"Launchbiz","values":{"presentation":"library","palette":"graphite","typography":"clean","coverGlow":false,"backdrop":"flat","selectionStyle":"outline","artFit":"cover","size":"compact","cupertinoReflections":"classic","cupertinoSpacing":"compact","berlinCoverSize":94.12526293442204,"kyotoTitlePlacement":"below","cupertinoTitlePlacement":"below","viennaSeparators":"space","coverCorners":"square","coverBrightness":"dimmed","menuButtons":"selected","coverBorder":"hairline","interfaceContrast":"crisp","titleWeight":"medium","coverShadow":"soft"}},{"name":"Minuet","values":{"presentation":"ulm","palette":"graphite","typography":"nunito","coverGlow":false,"backdrop":"flat","selectionStyle":"outline","artFit":"contain","size":"comfortable","cupertinoReflections":"subtle","cupertinoSpacing":"airy","berlinCoverSize":120,"kyotoTitlePlacement":"above","cupertinoTitlePlacement":"above","viennaSeparators":"lines","coverCorners":"square","coverBrightness":"even","menuButtons":"selected","coverBorder":"none","interfaceContrast":"crisp","titleWeight":"medium","ulmArtwork":false,"backgroundColor":"original","backgroundDim":60,"coverShadow":"off"}},{"name":"Niagaramond","values":{"presentation":"oxford","palette":"parchment","typography":"editorial","coverGlow":false,"backdrop":"flat","selectionStyle":"underline","artFit":"cover","size":"comfortable","cupertinoReflections":"subtle","cupertinoSpacing":"airy","berlinCoverSize":120,"kyotoTitlePlacement":"above","cupertinoTitlePlacement":"above","viennaSeparators":"space","coverCorners":"soft","coverBrightness":"even","menuButtons":"selected","coverBorder":"none","interfaceContrast":"soft","titleWeight":"regular","coverShadow":"soft"}},{"name":"Playrite","values":{"presentation":"berlin","palette":"midnight","typography":"clean","coverGlow":false,"backdrop":"flat","selectionStyle":"outline","artFit":"cover","size":"compact","cupertinoReflections":"subtle","cupertinoSpacing":"airy","berlinCoverSize":144,"kyotoTitlePlacement":"above","cupertinoTitlePlacement":"above","viennaSeparators":"lines","coverCorners":"square","coverBrightness":"even","menuButtons":"selected","coverBorder":"none","interfaceContrast":"crisp","titleWeight":"bold","coverShadow":"soft"}},{"name":"Title Commander","values":{"preserveOtherSettings":true,"presentation":"cambridge","palette":"amber","titleWeight":"regular","interfaceContrast":"crisp","cambridgeArtwork":true,"artFit":"cover","coverCorners":"square","coverBorder":"hairline","coverGlow":false,"backdrop":"flat","coverShadow":"off"}}];
let coverShadow='off';
...
function initAppearance(value){
 ...
 setCoverShadow(value.coverShadow);
 $('#cover-shadow').onchange=e=>{setCoverShadow(e.target.value);effect('select')};
 ...
 const sample=$('.appearance-sample img');sample.hidden=true;sample.addEventListener('load',()=>{sample.hidden=false;updateAppearancePreview();$('#appearance-preview').style.setProperty('--cover-glow-rgb',coverColor(sample)||'150,160,150')});sample.addEventListener('error',()=>{sample.hidden=true;sample.closest('.appearance-sample').hidden=true;$('#appearance-preview>p').textContent='No artwork to preview'});
 new MutationObserver(()=>{updateAppearancePreview();syncCupertinoPreviewAppearance()}).observe(document.body,{attributes:true,attributeFilter:['data-cover-shadow','data-cover-shadow-active','data-cover-border','data-cover-corners','data-cover-glow','data-art-fit','data-palette','data-presentation','data-backdrop','data-background-color','data-selection-style','data-cover-brightness','data-title-weight','style']});
...
function appearanceSnapshot(){return {cambridgeArtwork,ulmArtwork,coverShadow,coverBorder,interfaceContrast,titleWeight,presentation,palette,typography,coverGlow,backdrop,backgroundDim,backgroundColor,selectionStyle,artFit,size,cupertinoReflections,cupertinoSpacing,berlinCoverSize,kyotoTitlePlacement,cupertinoTitlePlacement,viennaSeparators,coverCorners,coverBrightness,menuButtons}}
...
function updateAppearancePreview(){
 ...
 if(!game?.image){sample.hidden=true;sample.closest('.appearance-sample').hidden=true;sample.removeAttribute('src');$('#appearance-preview>p').textContent='No artwork to preview';syncPreviewBackdrop();return;}
 ...
 sample.closest('.appearance-sample').hidden=sample.hidden;
 $('#appearance-preview>p').textContent=sample.hidden?'No artwork to preview':'Appearance preview';
...
function refreshApplicableAppearanceControls(){
 ...
 const shadow=artwork&&['library','berlin','seattle','vienna','prague','copenhagen','tokyo','oxford','ulm','cambridge'].includes(presentation);
 document.body.dataset.coverShadowActive=String(shadow);
 const rows={
  'cover-shadow':shadow,
...
// Static depth only: no image filters or shadow animation during navigation.
function setCoverShadow(value){
 coverShadow=['soft','crisp'].includes(value)?value:'off';
 document.body.dataset.coverShadow=coverShadow;
 $('#cover-shadow').value=coverShadow;persist();
}
