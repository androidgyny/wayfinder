const builtinBackgrounds={fort:{file:'fort-of-illusion.webp',credit:'Fort of Illusion by Luis Zuno (ansimuz). Used under the included permissive license; adapted as a 60-second parallax loop.'},alien:{file:'alien-environment.webp',credit:'Alien Environment by Luis Zuno (ansimuz) · CC0. Adapted as a 60-second parallax loop.'},another:{file:'another-world.webp',credit:'Another World by Luis Zuno (ansimuz) · CC0. Adapted as a 60-second parallax loop.'},mountain:{file:'mountain-dusk.webp',credit:'Mountain at Dusk by Luis Zuno (ansimuz) · CC0. Adapted as a looping parallax background.'},magical:{file:'magical-road.webp',credit:'Magical Road by Luis Zuno (ansimuz) · CC0. Adapted as a framed, 60-second parallax loop.'},urban:{file:'urban-landscape.webp',credit:'Urban Landscape by Luis Zuno (ansimuz) · CC0. Adapted as a skyline-framed, 60-second parallax loop.'}};
