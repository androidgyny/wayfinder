...
public class MainActivity extends Activity {
        ...
        web.setWebViewClient(new WebViewClient(){
            ...
            @Override public WebResourceResponse shouldInterceptRequest(WebView v,WebResourceRequest r){
                ...
                String path=u.getPath();try{
                    ...
                    String mime=path.endsWith(".js")?"application/javascript":path.endsWith(".css")?"text/css":path.endsWith(".jpg")?"image/jpeg":"text/html";
    ...
    public class Bridge {
        ...
        @JavascriptInterface public void setThemeColor(String color){if(color!=null&&color.matches("#[0-9a-fA-F]{6}"))runOnUiThread(()->{int value=Color.parseColor(color);getWindow().setStatusBarColor(value);getWindow().setNavigationBarColor(value);});}
